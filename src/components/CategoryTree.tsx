...
function CategoryNodeItem({ 
  ...
  const isActiveScope = hierarchyState.activeScopePath && 
    pathToKey(hierarchyState.activeScopePath) === pathKey;
  ...
  const matchesSearch = hierarchyState.searchQuery 
    ? hasMatchingDescendant(node, hierarchyState.searchQuery)
    : true;

  if (!matchesSearch && hierarchyState.searchQuery) {
    return null;
  }
  ...
  const sortedSources = [...node.sources].sort((a, b) => 
    a.name.localeCompare(b.name)
  );
  ...
  return (
    <div
      className={cn(
        ...
        matchesSearch && hierarchyState.searchQuery
  ...
  return (
    <div className="flex flex-col h-full">
        ...
        <div className="relative">
          ...
          {hierarchyState.searchQuery && (
            <button
              ...
              className="absolute right-2.5 top-1/2 -translate-y-1/2 p-0.5 hover:bg-secondary rounded"
            >
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-border/50">
        ...
        {(hierarchyState.activeScopePath || hasActiveFilters) && (
          <Button
            variant="ghost"
            size="sm"
            onClick={() => setActiveScopePath(null)}
              ...
              <div key={i} className="flex items-center gap-1">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    i === hierarchyState.activeScopePath!.length - 1 
      ...
      <div className="flex-1 overflow-y-auto p-2">
        ...
        {/* Root-level sources (no category) */}
